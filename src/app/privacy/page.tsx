...
const RICH = [
  ...
  "[&_th]:border-b [&_th]:border-border/25 [&_th]:py-2.5 [&_th]:pr-4 [&_th]:text-left [&_th]:text-xs [&_th]:font-bold [&_th]:text-muted",
  "[&_td]:border-b [&_td]:border-border/25 [&_td]:py-2.5 [&_td]:pr-4 [&_td]:align-top",
].join(" ");
