 ...
 */
/*
 * [결정 2026-09-04 01:30, 팀 최종] 1차 오픈 기간 Book It 은 **보이되 「오픈 예정」 안내**(호버 레이어, 화면 문구
 *   bookItNotice) — 9/3 밤의 "숨김" 결정은 팀 확인 후 이 방식으로 바뀌었다. 자리까지 없애야 할 때만 true.
 *   2차 노출(9/7) 때는 화면 문구에서 안내를 끄면 된다(배포 불필요).
 */
 ...
 * 꺼내 둔다. (이름은 상세 화면 브레드크럼과 맞춰 「공지사항」으로 통일한다, 2026-09-03.)
 *
