 ...
 */
/*
 * ⚠ [결정 2026-09-03 23:20, 사장님 확정] 1차 오픈 기간에는 Book It 메뉴를 **숨긴다**(팀 시트 원문).
 *   위 "오픈 예정 레이어로 보여주자"는 메모는 이 결정으로 대체됐다 — 다른 세션에서 false 로 되돌리지 말 것.
 *   운영(release/v1.1.7)도 숨김 상태. 2차 노출(9/7) 때 사용자 지시로 false 로 바꾼다.
 */
