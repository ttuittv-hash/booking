    ...
    <div className="rounded border border-border bg-panel/60 p-6">
      ...
      {!mySigned && (
        <div className="mt-4 space-y-3">
          <div className="max-h-48 overflow-y-auto rounded-sm border border-border bg-panel/40 p-3">
            <p className="text-[11.5px] font-medium text-muted">계약 확인사항 (초안 — 정식 대관계약서 확정 전 요약)</p>
            <ol className="mt-2 space-y-2 text-[12px] leading-5 text-muted">
          ...
          <button
            ...
            onClick={sign}
            className="w-full rounded-sm bg-accent px-4 py-2 text-[13px] font-semibold text-white transition-colors hover:bg-accent-hover disabled:opacity-50"
          >
            {busy ? "처리 중..." : "날인하기"}
          </button>
        </div>
