  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="relative flex h-9 w-9 items-center justify-center text-foreground transition-colors hover:text-accent"
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-1 grid h-4 min-w-4 place-items-center border border-foreground bg-accent px-1 text-[10px] leading-none font-bold text-on-accent tabular-nums">
