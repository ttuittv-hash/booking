  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1.5 grid h-3.5 min-w-3.5 place-items-center rounded-btn border border-foreground bg-accent px-1 text-xs leading-none font-bold text-on-accent tabular-nums">
      ...
      {open && (
        <div className="absolute right-0 z-40 mt-2 w-[22rem] animate-[dropdown-in_0.16s_ease-out] rounded-surface border border-border/25 bg-surface shadow-lg sm:w-[26rem]">
