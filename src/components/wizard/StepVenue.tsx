  ...
  return (
    <section>
      <StepHeading
        ...
        lead={
          <>
            어떤 공연을 준비하고 계신가요? 시설 · 무대 구성 · 규모를 먼저 고르면 공간 정보에
            맞는 예상 대관료 산정이 시작됩니다. 다음 화면에서 일정을 선택합니다.
          </>
        }
      />
      ...
      <StepForm>
        ...
        {hasSelection && (
          <div className="mt-10 border-t border-border/25 pt-8">
            ...
            <Note className="mt-8">
              공연명 · 출연진은 신청자 정보 화면과 자동 연동됩니다. 여기서 입력한 값은 신청서에
              그대로 채워지며, 신청자 정보에서 수정할 수 있습니다.
            </Note>
          </div>
        )}
      </StepForm>
